// background.template.js - 크롬 익스텐션 백그라운드 스크립트 템플릿
// 빌드 시 환경변수가 주입되어 안전한 background.js가 생성됩니다.

// 🔒 보안: 빌드 시 환경변수에서 주입되는 API 설정
const API_CONFIG = {
  supabase: {
    url: '{{SUPABASE_URL}}',
...
const BUILD_ENVIRONMENT = '{{BUILD_ENVIRONMENT}}';
